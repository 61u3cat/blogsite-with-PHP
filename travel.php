						...
						<div class="col-md-6 mb-4">
							<article class="card article-card article-card-sm h-100">
								...
								<div class="card-body px-0 pb-0">
									...
									<h2><a class="post-title" href="article.php">Is It Ethical to Travel Now? With That Freedom Comes Responsibility.</a></h2>
						...
						<div class="col-md-6 mb-4">
							<article class="card article-card article-card-sm h-100">
								...
								<div class="card-body px-0 pb-0">
									...
									<h2><a class="post-title" href="article.php">Eight
						...
						<div class="col-md-6 mb-4">
							<article class="card article-card article-card-sm h-100">
								...
								<div class="card-body px-0 pb-0">
									...
									<h2><a class="post-title" href="article.php">Portugal and France Now Allow Unvaccinated Tourists</a></h2>
									<p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna …</p>
